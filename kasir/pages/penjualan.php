...
if (isset($_GET['selesai'])) {
    unset($_SESSION['keranjang'], $_SESSION['sudah_simpan'], $_SESSION['penjualan_id'], $_SESSION['uang_diberikan'], $_SESSION['kembalian']);
    header("Location: penjualan.php");
    exit;
}

// Tambah ke keranjang via barcode
        ...
        <div class="container mt-4">
            ...
            <?php if (isset($_SESSION['sudah_simpan'])): ?>
                <div class="alert alert-success mt-4 struk-print">
                    ...
                    <strong>Uang Diberikan: Rp <?= number_format($_SESSION['uang_diberikan'] ?? 0) ?></strong><br>
                    <strong>Kembalian: Rp <?= number_format($_SESSION['kembalian'] ?? 0) ?></strong></p>
